...
describe('CustomerService', () => {
  ...
  describe('listCustomers', () => {
    it('should handle an error response', () => {
      service.listCustomers(1).subscribe({
        next: () => fail('expected an error, not customers'),
        error: (error: HttpErrorResponse) => {
          expect(error.status).toBe(500);
          expect(error.error).toBe('500 error');
        }
      });

      const req = httpMock.expectOne('http://localhost:8083/customers?page=1');
  ...
  describe('getCustomerById', () => {
    it('should handle an error response', () => {
      service.getCustomerById(1).subscribe({
        next: () => fail('expected an error, not customer'),
        error: (error: HttpErrorResponse) => {
  ...
  describe('createCustomer', () => {
    it('should create a new customer', () => {
      const mockCustomer: Partial<CustomerDTO> = { firstName: 'John', lastName: 'Doe', email: 'john.doe@example.com', addressId: 1, storeId: 1 };
  ...
  describe('updateCustomer', () => {
    it('should update a customer', () => {
      const mockCustomer: Partial<CustomerDTO> = { id: 1, firstName: 'John', lastName: 'Doe', email: 'john.doe@example.com', addressId: 1, storeId: 1 };
